...
const RepairActiveReservation = () => {
  ...
  useEffect(() => {
    const fetchActiveReservations = async () => {
      ...
      if (user) {
        const q = query(collection(db, 'RepairBookings'), where('userId', '==', user.uid), where('isActive', '==', true));
...
export default RepairActiveReservation;